...
//Умножение
export const MultiplicationMain = () => {
   ...
   return (
      <>
         ...
         <div className="multiplicationAnswer"><span className="answer">Верно: {countPlus}</span><span className="answer">Не верно: {countMinus}</span></div>
      </>
   )
};
